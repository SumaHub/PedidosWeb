...
class CDoctype
{
    ...
    /**
     * @ORM\ManyToOne(targetEntity=AdSequence::class)
     * @ORM\JoinColumn(name="docnosequence_id", referencedColumnName="ad_sequence_id", nullable=false)
     */
    private $ad_sequence;
    ...
    public function getAdSequence(): ?AdSequence
    {
        return $this->ad_sequence;
    }

    public function setAdSequence(?AdSequence $ad_sequence): self
    {
