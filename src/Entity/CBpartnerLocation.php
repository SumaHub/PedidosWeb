...
class CBpartnerLocation
{
    ...
    {
        if (!$this->c_order->contains($cOrder)) {
            $this->c_order[] = $cOrder;
            $cOrder->setCBpartnerLocation($this);
        }
    ...
    {
        if ($this->c_order->removeElement($cOrder)) {
            // set the owning side to null (unless already changed)
            if ($cOrder->getCBpartnerLocation() === $this) {
                $cOrder->setCBpartnerLocation(null);
            }
        }
