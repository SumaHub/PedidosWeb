...
class COrderline
{
    ...
    /**
     * @ORM\ManyToOne(targetEntity=COrder::class, inversedBy="c_orderlines")
     * @ORM\JoinColumn(referencedColumnName="c_order_id")
     */
    private $c_order;
    ...
    public function getCOrder(): ?COrder
    {
        return $this->c_order;
    }

    public function setCOrder(?COrder $c_order): self
    {
